...
public class SparkSqlJDBC {
	...
	public static void main(String[] args) {
		...
		SparkSession spark = SparkSession
				...
				.getOrCreate();
		if("postgresql".equalsIgnoreCase(type_db)){
			runJdbcDatasetPostgreSQL(spark,hostName,port,instance,user,password);
		}else if("mssqlserver".equalsIgnoreCase(type_db)){
			runJdbcDatasetMSSqlServer(spark,hostName,port,instance,user,password);
		}else if("mysql".equalsIgnoreCase(type_db)){
			runJdbcDatasetMySQL(spark,hostName,port,instance,user,password);
		}
		
		spark.stop();
	}

	private static void runJdbcDatasetMySQL(SparkSession spark, String hostName,
			String port, String instance, String user, String password) {
	...
	private static void runJdbcDatasetMSSqlServer(SparkSession spark, String hostName, String port, String instance, String user, String password) {
	...
	private static void runJdbcDatasetPostgreSQL(SparkSession spark, String hostName, String port, String instance, String user, String password) {
